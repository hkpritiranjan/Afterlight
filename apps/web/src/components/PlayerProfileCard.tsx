...
export default function PlayerProfileCard({ lightBalance }: Props) {
  return (
    <div style={card}>
      ...
      <div style={info}>
        <div style={name}>Wanderer</div>
        <div style={sub}>Light Bearer</div>
        <div style={lightRow}>
...
const info: React.CSSProperties = { display: 'flex', flexDirection: 'column', gap: 2 };
const name: React.CSSProperties = {
  fontSize: 14, fontWeight: 700, color: 'var(--text-hi)',
  fontFamily: "'Palatino Linotype', 'Book Antiqua', Georgia, serif",
};
const sub: React.CSSProperties = { fontSize: 10, color: 'var(--text-lo)', letterSpacing: '0.06em', textTransform: 'uppercase', fontWeight: 600 };
